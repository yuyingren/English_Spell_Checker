...
# ----> the error words(2 characters
#       more or less than the error) as the candidates. 
# This come from the intuition that the errors should be very similar to the correct words.
#----> limit the candidtes set again by calculating the minimum edit distance between elements in candidates1 and
#       the errors. Since the errors are simulated only by one of the random oeprations: insertion, deletaion, substitution,
#       we will limit the candidates to the words have only 1 edit distance from the error words. 
